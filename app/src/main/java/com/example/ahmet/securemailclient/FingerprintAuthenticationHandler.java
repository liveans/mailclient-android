...
public class FingerprintAuthenticationHandler extends
    ...
    // Constructor
    public FingerprintAuthenticationHandler(Context mContext,int mMailIndex) {
        context = mContext;
    ...
    public void update(String e, Boolean success){
        ...
        if(success){
            ...
            Intent i = new Intent(context, DecryptedMessage.class);
            i.putExtra("mailData",mailIndex);
