...
public class Constants {
    ...
    public static final String PUBLIC_KEY_SUBJECT_NAME="[PUBLIC KEY SECURE CLIENT]";
    public static final String ENCRYPTED_MESSAGE_HEADER_NAME="[ENCRYPTED MESSAGE SECURE CLIENT]";
