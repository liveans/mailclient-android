...
public class PgpUtils {
    ...
    public static String decrypt(String encryptedText, String password,String secretKey) throws Exception {
        ...
        while (sKey == null && enc.getEncryptedDataObjects().hasNext()) {
            ...
            sKey = getPrivateKey(getPGPSecretKeyRing(secretKey), pbe.getKeyID(), password.toCharArray());
        }
        if (pbe != null) {
    ...
    //PGPPublicKey -> message
    //message -> PGPSecretKey
